...
#clubes;----------------ok
#• o número de pessoas de Niterói torcedoras do Fluminense----------------ok
...
for x in range(5):
	...
	time = int(input('Digite o múmero correspondente ao time ou zero para sair do programa: Fluminense = 1 Botafogo = 2 Vasco = 3 Flamengo = 4 Outros = 5 Sair = 0:  '))
...
print(f'O número de pessoas moradoras do Rio de Janeiro é {quantidaderiodejaneiro} e a quantidade de torcedores de outros times é {quantidadeoutros}')
	
print(f'O número de pessoas de Niterói é {quantidadeniteroi} e torcedoras do Fluminense é {quantidadefluminense}')
