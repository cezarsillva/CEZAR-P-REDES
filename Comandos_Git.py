...
# Para adicionar um arquivo no github: (git add .)
# Para adicionar  a atualização (git commit -m "Mensagem para atualização")
# Para puxar o arquivo para o github: (git push)
...
#Listas agrupam um conjunto de elementos variados, podendo conter:
