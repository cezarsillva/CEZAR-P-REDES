...
# quantidadeproduto = int(input('Digite a quantidade de produto: '))
# valorunitarioproduto = float(input('Digite o valor unitário do produto: '))


# total = quantidadeproduto * valorunitarioproduto



# print('-------------------------------------------------------------------------------------------')
# print(f'A QUANTIDADE TOTAL DE PRODUTO É: {quantidadeproduto} E O VALOR TOTAL DA COMPRA É: {total} ')
# print('-------------------------------------------------------------------------------------------')
